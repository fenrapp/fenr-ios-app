...
Run the applicable commands from `docs/testing.md`. For UI changes, inspect simulator output at the intended device/orientation before claiming the work is complete. Do not commit build products, `xcuserdata`, local captures, provisioning files, or secrets.
