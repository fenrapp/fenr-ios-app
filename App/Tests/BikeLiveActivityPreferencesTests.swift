...
struct BikeLiveActivityPreferencesTests {
    ...
    func preventsStart(disableAll: Bool) async {
        ...
        await fixture.settingsRepository.save(.init(liveActivities: preferences))
    ...
    func dismissesActiveCharge() async {
        ...
        await fixture.settingsRepository.save(.init(liveActivities: .init(showsCharging: false)))
    ...
    func updatesPresentationImmediately() async {
        ...
        #expect(await waitUntil { fixture.activityClient.isActive })
        await fixture.settingsRepository.save(.init(liveActivities: .init(ridingDetailLevel: .summary)))
    ...
    func disableDuringRecovery() async {
        ...
        await fixture.settingsRepository.save(.init(liveActivities: .init(isEnabled: false)))
        #expect(await waitUntil { fixture.activityClient.dismissCount == 1 })
