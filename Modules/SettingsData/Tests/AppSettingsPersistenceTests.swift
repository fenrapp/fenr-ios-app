    ...
    func persistsSettings() async throws {
        ...
        let expected = AppSettings(
            ...
            rideNavigation: RideNavigationSettings(
                avoidsTolls: true,
                avoidsHighways: true,
                preferredMapStyle: .satellite, mapMode: .offline,
        ...
        let changes: [AppSettingsChange] = [
            ...
            .navigation(.preferredMapStyle(.satellite)), .navigation(.mapMode(.offline)),
            ...
            .navigation(.showsRoadsInFocus(true)), .navigation(.mapOrientation(.northUp)),
